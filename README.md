...
Jev launched in early access on 15 September 2026. This catalog is curated and maintained by **AIPersona Academy (APA)** to empower engineers, autonomous agent builders, and AI persona architects. This list is independent and not officially affiliated with TypeSafe AI. Pull requests and community contributions are welcome — the ecosystem is young and growing fast.
...
- [laya](https://github.com/NandhaKishorM/laya) - Lightweight local 421M open-source decision model delivering sub-15ms inference (~86.5 decisions/sec) for real-time game loops and agent inner loops with zero network latency.
- [kev](https://github.com/jaredpalmer/kev) - Family of open-source Jev-like decision models (0.6B, 4B, 8B) based on Qwen3 with LoRA + pointer head. Drop-in TypeSafe System One API compatibility via single base_url change, ~40ms on H100, Apache 2.0.
...
Architectural recipes from the docs & AIPersona Academy engineering standards.
...
Curated and maintained with ❤️ by **APA (AIPersona Academy)** — empowering the global community of autonomous AI persona architects and System One researchers.
