...
- [kev](https://github.com/jaredpalmer/kev) - 基于 Qwen3 与 LoRA + pointer head 的开源 Jev 风格决策模型家族（0.6B、4B、8B）。只需更改单个 base_url 即可无缝兼容 TypeSafe System One API，H100 上单次决策约 40ms，采用 Apache 2.0 协议。
